...
console.log(car.string(), car.valueOf());
...
Truck.prototype.specific = function(n) {
  return (n > this.towingCapacity) ?
  "Навантаження занадто важке для буксирування" : "Тягнення навантаження..."
};
...
const driveFunction = drive.bind(car, 100);
...
console.log(electricCar.string());